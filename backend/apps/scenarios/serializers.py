...
class RequestSerializer(serializers.ModelSerializer):
    class Meta:
        model = Request
        fields = ['id', 'name', 'method', 'url', 'headers', 'body_type', 
                  'body', 'weight', 'think_time', 'timeout', 'order']
...
class ScenarioListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Scenario
        fields = ['id', 'name', 'description', 'request_count', 'is_imported_from_har', 
...
class ScenarioCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Scenario
        fields = ['name', 'description', 'default_users', 'default_spawn_rate', 
                  'default_duration', 'requests']
